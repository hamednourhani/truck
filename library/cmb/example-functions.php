 ...
 *
 * Be sure to replace all instances of 'truck_' with your project's prefix.
...
add_action( 'cmb2_init', 'truck_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_init' hook.
 */
function truck_register_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'truck_before_row_if_2', // callback
...
add_action( 'cmb2_init', 'truck_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function truck_register_about_page_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_truck_about_';
...
add_action( 'cmb2_init', 'truck_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function truck_register_repeatable_group_field_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_truck_group_';
...
add_action( 'cmb2_init', 'truck_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function truck_register_user_profile_metabox() {
...
add_action( 'cmb2_init', 'truck_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function truck_register_theme_options_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$option_key = '_truck_theme_options';
